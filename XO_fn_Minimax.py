...
#     return redundant_optimal[randnum]
    ...
    # *IMPORTANT: random choice to make it winnable for the player
    # intended for player to able to select difficulty
    # not enough time for implementation
    randChoice = random.randint(0,9)
    oneThirdList = [redundant_optimal[0],redundant_optimal[0],randChoice]

    return random.choice(oneThirdList)
